...
class Dataset(object):
    ...
    def load(self, verbose=True):
        ...
        self.train = _pluck(identities, train_pids, relabel=True) # (images, index, camid, video_id)
        self.query = _pluck(identities, self.split['query'])    # (images, pid, camid, video_id)
        self.gallery = _pluck(identities, self.split['gallery'])    # (images, pid, camid, video_id)
